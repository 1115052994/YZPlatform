...
import com.plt.yzplatform.camera.test.ModelEnums;
import com.plt.yzplatform.camera.test.WindowUtil;
...
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_CEMIAN;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_CHELUN;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_CHEYAOSHI;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_CHIMENGCAOKONGQU;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_DANGWEI;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_DENGGUANGKONGZHI;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_DIPAN;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_FADONGJI;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_FANGXIANGPAN;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_HOUBEIXIANG;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_HOUCHEDENG;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_HOUZUOYI;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_QIANDADENG;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_QIANFANG45DU;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_QIANZUOYI;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_TIANCHUANG;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_XIANSHIPING;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_YAOSHIKONG;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_YIBIAOPAN;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_YUSHUAQI;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_ZHENGHOUFANG;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_ZHENGQIANFANG;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_ZHONGKONGQU;
import static com.plt.yzplatform.camera.test.ModelEnums.MODEL_ZHUOQIANCHEMENG;
