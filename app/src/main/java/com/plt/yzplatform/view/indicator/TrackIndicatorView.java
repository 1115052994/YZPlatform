package com.plt.yzplatform.view.indicator;
...
public class TrackIndicatorView extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private float mTabVisibleNums = 0;
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        ...
        mTabVisibleNums = array.getFloat(R.styleable.TrackIndicatorView_tabVisibleNums, mTabVisibleNums);
        // 回收
        array.recycle();
    }
...
//            }
        ...
        mAdapter.highLightIndicator(mIndicatorGroup.getItemAt(0),mCurrentPosition);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (/*changed && mItemWidth == 0 &&*/ mAdapter != null) {
            ...
            for (int i = 0; i < mAdapter.getCount(); i++) {
                View childView = mIndicatorGroup.getItemAt(i);
            ...
            // 8.添加底部跟踪的指示器
            mIndicatorGroup.addBottomTrackView(mAdapter.getBottomTrackView(), (int)mItemWidth);
        }
    }
