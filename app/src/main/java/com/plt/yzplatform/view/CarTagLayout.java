...
public class CarTagLayout extends ViewGroup {

    private List<List<View>> mChildViews = new ArrayList<>();

    public CarTagLayout(Context context) {
        super(context);
    }

    public CarTagLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CarTagLayout(Context context, AttributeSet attrs, int defStyleAttr) {
