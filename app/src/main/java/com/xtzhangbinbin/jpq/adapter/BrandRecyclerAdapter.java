...
public abstract class BrandRecyclerAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public BrandRecyclerAdapter(Context context, List<T> data, int layoutId) {
     ...
     */
    public BrandRecyclerAdapter(Context context, List<T> data, MultiTypeSupport<T> multiTypeSupport) {
        this(context, data, -1);
