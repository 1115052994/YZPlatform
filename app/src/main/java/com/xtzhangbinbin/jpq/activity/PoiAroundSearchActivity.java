 ...
 * 介绍poi周边搜索功能
 */
public class PoiAroundSearchActivity extends BaseActivity implements
	...
	protected void onStart() {
		...
		setLeftImageClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				JumpUtil.newInstance().finishRightTrans(PoiAroundSearchActivity.this);
			}
		});
	}
		...
		mPoiDetail.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mlastMarker !=null){
					...
					ToastUtil.show(PoiAroundSearchActivity.this,"正在进入导航，请稍等...");
					navigation(point.getLatitude(),point.getLongitude());
				}
			}
		});
	...
	protected void doSearchQuery() {
		keyWord = "加油站";//mSearchText.getText().toString().trim();
		currentPage = 0;
	...
	public void onPoiSearched(PoiResult result, int rcode) {
		if (rcode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getQuery() != null) {// 搜索poi的结果
					...
					if (poiItems != null && poiItems.size() > 0) {
						...
						.icon(BitmapDescriptorFactory
								.fromBitmap(BitmapFactory.decodeResource(
										getResources(), R.drawable.locaation)))
						.position(new LatLng(lp.getLatitude(), lp.getLongitude())));
				...
				ToastUtil
						.show(PoiAroundSearchActivity.this, "对不起，没有搜索到相关数据！");
			}
		} else  {
	...
	private void resetlastmarker() {
		...
		if (index < 10) {
			...
			BitmapFactory.decodeResource(getResources(), R.drawable.poi_jiayouzhan_smal)));
		}
		mlastMarker = null;
...
//		mPoiAddress.setText(mCurrentPoi.getSnippet()+mCurrentPoi.getDistance());
		mPoiAddress.setText(mCurrentPoi.getCityName()+mCurrentPoi.getAdName()+mCurrentPoi.getSnippet()+"("+mCurrentPoi.getDistance()+"米)");
	}
	...
	private int[] markers = {R.drawable.poi_jiayouzhan_mid,
			R.drawable.poi_jiayouzhan_mid,
			R.drawable.poi_jiayouzhan_mid,
			R.drawable.poi_jiayouzhan_mid,
			R.drawable.poi_jiayouzhan_mid,
			R.drawable.poi_jiayouzhan_mid,
