...
import com.xtzhangbinbin.jpq.adapter.SearchResultAdapter;
import com.xtzhangbinbin.jpq.base.BaseActivity;
import com.xtzhangbinbin.jpq.utils.JumpUtil;
import com.xtzhangbinbin.jpq.view.SegmentedGroup;
...
public class MapActivity extends BaseActivity implements LocationSource,
    ...
    private static final String TAG = "地图选点" ;
    ...
    private void initView() {
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    //第二个参数为"" 时  搜索全国范围内的关键词 或指定城市的关键词 如："济南"
    ...
    private void setUpMap() {
        ...
        myLocationStyle.strokeColor(R.color.theme_coloer);
        myLocationStyle.radiusFillColor(R.color.theme_coloer);
    ...
    AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                Log.i(TAG, "onItemClick地址下: " + poiItem.getCityName() + poiItem.getAdName() + poiItem.getSnippet());
                Log.d(TAG, "onItemClick地址title:" + poiItem.getTitle());
                Log.w(TAG, "onItemClick地址经纬: " + poiItem.getLatLonPoint().getLatitude() + "---" + poiItem.getLatLonPoint().getLongitude() );
//                ToastUtil.show(MapActivity.this,poiItem.getCityName() + poiItem.getAdName() + poiItem.getSnippet() + poiItem.getTitle());
                String address = "";
                Bundle bundle = new Bundle();
                if (!poiItem.getCityName().isEmpty() && !poiItem.getAdName().isEmpty()){
...
//                JumpUtil.newInstance().finishRightTrans(MapActivity.this,bundle,001);
    ...
    private void addMarkerInScreenCenter(LatLng locationLatLng) {
        ...
        locationMarker = aMap.addMarker(new MarkerOptions()
                .anchor(0.5f,1.0f)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.locaation)));
    ...
    private void searchPoi(Tip result) {
        ...
        inputSearchKey = result.getName();//getName();//getAddress(); // + result.getRegeocodeAddress().getCity() + result.getRegeocodeAddress().getDistrict() + result.getRegeocodeAddress().getTownship();
    ...
    protected void onStart() {
        ...
        setLeftImageClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                JumpUtil.newInstance().finishRightTrans(MapActivity.this);
            }
        });
    }
