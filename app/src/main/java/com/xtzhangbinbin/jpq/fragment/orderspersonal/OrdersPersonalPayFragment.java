...
public class OrdersPersonalPayFragment extends Fragment {
    ...
    public OrdersPersonalPayFragment(Context context) {
...
//        getOrders(Config.ORDERS_GET_LIST, 1, null);
    ...
    public void getOrders(String url, final int pageIndex, final RefreshLayout refreshlayout) {
        ...
        map.put("order_type", OrderPersState.yzfwsy.toString());
        ...
        if (NetUtil.isNetAvailable(context)) {
            OKhttptils.post((Activity) context, url, map, new OKhttptils.HttpCallBack() {
                ...
                public void success(String response) {
                    ...
                    //没有信息图片显示
                    if (OrdersPersonalPayFragment.this.result.size() <= 0) {
